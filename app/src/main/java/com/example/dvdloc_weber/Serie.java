...
public class Serie extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnRetourSeries = (Button) findViewById(R.id.btnRetourSeries);

        btnRetourSeries.setOnClickListener(new Button.OnClickListener(){
            @Override
            public void onClick(View arg0) {
                ...
                alertDialog.setPositiveButton("Oui", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface arg0, int arg1) {
                        Toast.makeText(getApplicationContext(), btnRetourSeries.getText(), Toast.LENGTH_LONG).show();
